...
Each page below profiles a concrete school or schooling model available to valley families, assessed against all ten [[variables/index|variables]]. The summary table at the top of each page gives a quick read. The variable-by-variable assessment underneath gives the detail. The "Best fit" section at the bottom states plainly who the option suits and who it doesn't.
...
**[[options/immediate/greyton-house|Greyton House (Grade 8-9)]]** — Greyton. Registered independent school (ISASA member). English-medium. Currently Grade R to 7; WCED registration already covers Grades 8 and 9. Subject to board clearance and accommodation. Covers senior phase only (Grade 8-9); a transfer to another school is required for FET (Grade 10-12).

**[[options/immediate/microschool|Microschool / Learning Pod]]** — Parent-organised collective home education using an accredited online provider, a shared facilitator, and a local venue. Not a registered school. The lowest-barrier collective solution that keeps children physically together in the valley.
...
**[[options/immediate/curro-hermanus|Curro Hermanus High School]]** — Sandbaai, Hermanus. Independent school (Curro Group). English and Afrikaans. IEB examination. Max 25 per class. ~80 km from Greyton, but school bus collects from Caledon (35 km). ~R88,000/year fees; ~R107,000 to R136,000/year total with lift club to Caledon.
...
If you have already worked through the [[variables/index|variable pages]] or used the [[tools/ai-assistant|AI prompt]], you know your priorities. Use the comparison table above to eliminate options that clearly don't fit, then read the remaining profiles in full.
